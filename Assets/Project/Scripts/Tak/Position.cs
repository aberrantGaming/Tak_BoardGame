...
//            analysis.WhiteGroups = Bitboard.Bitboard.FloodGroups(cfg.c, wr, alloc);
//            alloc = analysis.WhiteGroups;
//            alloc = new List<ulong>(alloc.Capacity);
//            analysis.BlackGroups = Bitboard.Bitboard.FloodGroups(cfg.c, br, alloc);
//        }
